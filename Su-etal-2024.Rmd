...
list.files(path="./(Figure 1-2) PREE", pattern=".csv$", recursive = TRUE)
list.filenames <- list.files(path="./(Figure 1-2) PREE", pattern = ".csv$", 
                             full.names=TRUE, recursive = TRUE)
# delete the metadata from the list.filenames
list.filenames <- list.filenames[!(str_detect(list.filenames, "metadata"))]
list.filenames
metadata <- read.csv("./(Figure 1-2) PREE/metadata.csv")
list.data <- list()
...
for (i in 1:length(list.filenames)) {
  ...
  list.data[[i]]$ExpDetails <- str_sub(list.filenames[[i]], 40
                                       , -5)
...
list.files(path="./(Figure 3) PREE_LowUS_10percent", pattern=".csv$", recursive = TRUE)
list.filenames <- list.files(path="./(Figure 3) PREE_LowUS_10percent", pattern = ".csv$", 
                             full.names=TRUE, recursive = TRUE)
# delete the metadata from the list.filenames
list.filenames <- list.filenames[!(str_detect(list.filenames, "metadata"))]
list.filenames
metadata <- read.csv("./(Figure 3) PREE_LowUS_10percent/metadata.csv")
list.data <- list()
...
for (i in 1:length(list.filenames)) {
  ...
  list.data[[i]]$ExpDetails <- str_sub(list.filenames[[i]], 54, -5)
  #remove the first and last characters 
  list.data[[i]] <- dplyr::select(list.data[[i]], -c(Animal, Group))
}
...
list.files(path="./(Figure 4B-C) One FC", pattern=".csv$", recursive = TRUE)
list.filenames <- list.files(path="./(Figure 4B-C) One FC", pattern = ".csv$", 
                             full.names=TRUE, recursive = TRUE)
# delete the metadata from the list.filenames
list.data <- list()
...
list.files(path="./(Figure 4E-F) Interpolated Extinction", pattern=".csv$", recursive = TRUE)
list.filenames <- list.files(path="./(Figure 4E-F) Interpolated Extinction", pattern = ".csv$", 
                             full.names=TRUE, recursive = TRUE)
# delete the metadata from the list.filenames
list.data <- list()
